    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.PositiveBigIntegerField(default=0)),
                ('order_status', models.CharField(choices=[('Order Recived', 'Order Recived'), ('Order Processing', 'Order Processing'), ('Order completed', 'Order completed'), ('On the way', 'On the way'), ('Order cancelled', 'Order cancelled')], max_length=200)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
